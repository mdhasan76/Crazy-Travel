        ...
        <div className='text-white relative bg-gradient-to-t from-stone-800 to-slate-800  
            h-[480px]'>
                ...
                <div className='grid place-content-center h-full mx-auto p-10 md:p-20'>
                 <h2 className=' font-bold mb-3 tracking-[5px] text-3xl flex items-center text-center'>SEARCH FOR A HOTEL</h2>
                 <p className='text-center mt-5 font-medium'>Get the best deal & offers</p>
                </div>
            </div>
    );
};
